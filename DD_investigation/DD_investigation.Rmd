...
#Compare M values between the two OMs
Mcompare <- cbind(Mtrue, Mtrue2)
boxplot(Mcompare, names=c("True M base", "True M bias"), col=c("lightgray", "lightblue"))
...
TACbase2 <- pcod_mse2@TAC

TACcompare <- cbind(TACbase, TACbase2)
