...
* There was a recommendation to reduce F~Max~ from 4 to a lower value in some MPs.
...
* There was a suggestion to us *B* instead of *SB* or *SSB* for spawning biomass and standardise throughout.

<!-- I haven't included these comments of Rowan's. I'm not sure I agree with the first one and not sure how to build it in as a recommendation ... except maybe think about it? The second one seems to be more of a comment to check something. Please add them if you think they should be incorporated. I wasn't sure what to say about them:
...
I think I got Ashleen's comments in the various sections -->
