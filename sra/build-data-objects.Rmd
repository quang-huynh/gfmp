...
Build and fill the data object

```{r make-data-object-pc, warning=FALSE, message=FALSE, echo=TRUE}
...
mean_length <- dplyr::filter(dpc$commercial_samples) %>%
