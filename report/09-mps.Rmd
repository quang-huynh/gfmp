...
In addition to the data-based MPs described above, we propose including a simple surplus production model paired with a harvest control rule as a model-based MP. Here, we use the surplus production model implemented in MSEtool [@huynh_msetool_2019] and based on @fletcher1978. Here we include a modified version of the model description from the package vignette for completeness.
