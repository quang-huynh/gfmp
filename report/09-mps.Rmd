...
These MPs incrementally adjust the TAC in an attempt to maintain a constant relative abundance index (Fig. \@ref(fig:mp-islope-demo)).
...
For our BC groundfish fisheries, we do not have an a priori expectation that they are currently being overfished. We therefore propose the following set that start TAC at 80% or 100% of average catch over the last 5 historical years:
