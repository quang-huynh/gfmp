...
There are only `r n_caught` fish with measured lengths in the WCVI commercial data.

We will leave this parameter blank here... TODO

```{r desc-selectivity-function, eval=FALSE, include=FALSE}
...
fleet_rex@LFS <- c(0.9, 1.1) * mean(L50)
round(fleet_rex@LFS, 1)
```
