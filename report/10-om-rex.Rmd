...
The maximum recorded age for a Rex Sole in BC waters is 15 in the Hecate Strait Multispecies Assemblage survey in 1998. We do not have ages in our database for 3CD to inform the maximum age for this region. @munk2001 note the maximum age observed for Rex Sole in the Gulf of Alaska is 27 years.

TODO: this gets overwitten by SRA
...
@mcgilliard2017 used 0.17 for M but they also note that growth rates and size can vary with latitude, which can affect M. M is likely slightly higher in BC at lower latitudes. Here, we add range of possible M values starting with a lower bound of that from @mcgilliard2017. We include an alternative scenario with a higher M value elsewhere.
...
@maunder2012 cite @myers1999 who found a median value of steepness of 0.80 for flatfish and note that, because of the bias in the value estimated for North Atlantic Cod in that paper, the value might be closer to 0.94. @grandin2017arrowtooth estimated steepness for Arrowtooth Flounder, but found their posterior was highly influenced by their prior (they estimated a median of 0.88 with a 95% confidence interval of 0.69--0.98). Here we will choose a value that approximately encompasses this range. We include alternative steepness scenarios elsewhere.
...
@thorson2014 found the mean autocorrelation for Pleuronectiformes to be about 0.44 with a standard deviation of about 0.27.
...
We do not have enough ages in our database to fit a von Bertalanffy model (and none for 3CD), but we can look at the distribution of lengths from our survey samples. This is the distribution across all fish sampled across the WCVI synoptic survey.
...
We will explore an alternative scenario with $L_\mathrm{Inf} = 37.2$ cm based on female fish from Oregon [@hosie1976].
...
However, we can look at the commercial samples from our entire coast:
