...
`r round(stock_rex@L50, 1)` is between the length at 50% maturity reported for Rex Sole off Oregon (24cm) and the Gulf of Alaska (35cm)  [@abookire2005].
...
fleet_rex@LFS <- c(0.9, 1.1) * stock_rex@L50
...
The size slots have been entered as absolute units (cm).
