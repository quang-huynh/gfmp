...
"Imp",     "TACFrac[1]",    "$\\textrm{LB}_\\textrm{TAC}$",       "Lower bound of Uniform distribution of TAC fraction",
"Imp",     "TACFrac[2]",    "$\\textrm{UB}_\\textrm{TAC}$",       "Upper bound of Uniform distribution of TAC fraction",
"Imp",     "TACSD",      "$\\sigma_\\textrm{bTAC}$",   "SD in lognormal fraction of TAC taken"
)

#(\\textrm{LB}_{\\textrm{TAC})
