...
which is the average unfished spawning biomass over the first $\theta_{a50}$ (age-at-maturity) years of the historical period (rounded up to the nearest integer) and $B_\textrm{unfished}^y$ is calculated $B_0$ (Equation \@ref(eq:dlm-om-bo)). Other alternative interpretations of $B_0$ could also be programmed (e.g., average $B_0$ across the whole historical period, or at the end of the historical period), depending on the desired benchmark or target.
