...
where ${{b}}_{\textrm{TAC}}$ is an improper fraction (e.g. ${{b}}_{\textrm{TAC}}$ = 0.7 is equivalent to 30% catch underages) and the lognormal error term $\varepsilon_{\textrm{TAC},y}$, is drawn from a normal distribution whose standard deviation ${\sigma}_{\textrm{TAC}}$ can be sampled at random in each simulation:
