...
1. Eliminate MPs with P40 < 0.9.
1. Eliminate MPs with P100 < 0.6.
1. Eliminate MPs with PNOF < 0.6.
1. Eliminate MPs with LTY < 0.6.
...
The resulting MPs were `r top_top_pm_names`: (Fig. \@ref(fig:screening-radar-reference), \@ref(fig:screening-radar-length), \@ref(fig:screening-radar-average-catch), \@ref(fig:screening-radar-moderate)) Fig. \@ref(fig:screening-trade-off1) Fig. \@ref(fig:screening-trade-off2) Fig. \@ref(fig:screening-trade-off3).

The current top MPs:
*FIXME: lots of MPs not here depending on how we do the filtering.*

IT5 + IT10: An index target MP where the TAC is modified according to current index levels (mean index over last 5 years) relative to a target level. IT5: Maximum annual changes in TAC are 5 per cent. IT10: Maximum annual changes are 10 per cent.
...
```{r screening-trade-off1, fig.cap="Performance trade-offs 1. FIXME: these made more sense before there were so many candidates MPs."}
