...
1. Eliminate MPs with P40 < 0.8.
1. Eliminate MPs with P100 < 0.5.
1. Eliminate MPs with PNOF < 0.5.
1. Eliminate MPs with LTY < 0.5 LTY from adjusting TAC to MSY each assessment interval (F~MSY ref~).
...
```{r screening-radar-all, fig.cap="Radar plots of performance metrics across screened management procedures.", fig.pos="p"}
