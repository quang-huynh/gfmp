...
plot_probs(short_mse, PMlist = c("P40", "P80", "PNOF", "AAVY", "LTY"))
```

```{r probability-table-0-1, fig.width = 9, fig.asp = 1, out.width = "4in"}
plot_probs(short_mse, PMlist = c("P40", "P80", "PNOF", "AAVY", "LTY"), scale_0_1 = TRUE)
```
...
x <- trade_off(short_mse,
               ...
               lims = c(0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5))
Tplot(short_mse)
Tplot2(short_mse)
```
