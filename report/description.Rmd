...
```{r, data-Name, results = FALSE, echo = TRUE}
data@Name
```
...
```{r, data-Common_Name, results = FALSE, echo = TRUE}
data@Common_Name
```
...
```{r, data-Species, results = FALSE, echo = TRUE}
data@Species
```
...
```{r, data-Region, results = FALSE, echo = TRUE}
data@Region
```
...
```{r, data-Year, results = FALSE, echo = TRUE}
data@Year
```
...
```{r, data-Cat, results = FALSE, echo = TRUE}
data@Cat
```
...
```{r, data-Ind, results = FALSE, echo = TRUE}
data@Ind
```
...
```{r, data-Type, results = FALSE, echo = TRUE}
data@Type
```
...
```{r, data-RInd, results = FALSE, echo = TRUE}
data@RInd
```
...
```{r, data-Rec, results = FALSE, echo = TRUE}
data@Rec
```
...
```{r, data-t, results = FALSE, echo = TRUE}
data@t
```
...
```{r, data-AvC, results = FALSE, echo = TRUE}
data@AvC
```
...
```{r, data-Dt, results = FALSE, echo = TRUE}
data@Dt
```
...
```{r, data-Mort, results = FALSE, echo = TRUE}
data@Mort
```
...
```{r, data-FMSY_M, results = FALSE, echo = TRUE}
data@FMSY_M
```
...
```{r, data-BMSY_B0, results = FALSE, echo = TRUE}
data@BMSY_B0
```
...
```{r, data-L50, results = FALSE, echo = TRUE}
data@L50
```
...
```{r, data-L95, results = FALSE, echo = TRUE}
data@L95
```
...
```{r, data-ML, results = FALSE, echo = TRUE}
data@ML
```
...
```{r, data-Lbar, results = FALSE, echo = TRUE}
data@Lbar
```
...
```{r, data-Lc, results = FALSE, echo = TRUE}
data@Lc
```
...
```{r, data-LFC, results = FALSE, echo = TRUE}
data@LFC
```
...
```{r, data-LFS, results = FALSE, echo = TRUE}
data@LFS
```
...
```{r, data-CAA, results = FALSE, echo = TRUE}
data@CAA
```
...
```{r, data-Dep, results = FALSE, echo = TRUE}
data@Dep
```
...
```{r, data-Abun, results = FALSE, echo = TRUE}
data@Abun
```
...
```{r, data-SpAbun, results = FALSE, echo = TRUE}
data@SpAbun
```
...
```{r, data-vbK, results = FALSE, echo = TRUE}
data@vbK
```
...
```{r, data-vbLinf, results = FALSE, echo = TRUE}
data@vbLinf
```
...
```{r, data-vbt0, results = FALSE, echo = TRUE}
data@vbt0
```
...
```{r, data-LenCV, results = FALSE, echo = TRUE}
data@LenCV
```
...
```{r, data-wla, results = FALSE, echo = TRUE}
data@wla
```
...
```{r, data-wlb, results = FALSE, echo = TRUE}
data@wlb
```
...
```{r, data-steep, results = FALSE, echo = TRUE}
data@steep
```
...
```{r, data-sigmaR, results = FALSE, echo = TRUE}
data@sigmaR
```
...
```{r, data-CV_Cat, results = FALSE, echo = TRUE}
data@CV_Cat
```
...
```{r, data-CV_Dt, results = FALSE, echo = TRUE}
data@CV_Dt
```
...
```{r, data-CV_AvC, results = FALSE, echo = TRUE}
data@CV_AvC
```
...
```{r, data-CV_Ind, results = FALSE, echo = TRUE}
data@CV_Ind
```
...
```{r, data-CV_Mort, results = FALSE, echo = TRUE}
data@CV_Mort
```
...
```{r, data-CV_FMSY_M, results = FALSE, echo = TRUE}
data@CV_FMSY_M
```
...
```{r, data-CV_BMSY_B0, results = FALSE, echo = TRUE}
data@CV_BMSY_B0
```
...
```{r, data-CV_Dep, results = FALSE, echo = TRUE}
data@CV_Dep
```
...
```{r, data-CV_Abun, results = FALSE, echo = TRUE}
data@CV_Abun
```
...
```{r, data-CV_vbK, results = FALSE, echo = TRUE}
data@CV_vbK
```
...
```{r, data-CV_vbLinf, results = FALSE, echo = TRUE}
data@CV_vbLinf
```
...
```{r, data-CV_vbt0, results = FALSE, echo = TRUE}
data@CV_vbt0
```
...
```{r, data-CV_L50, results = FALSE, echo = TRUE}
data@CV_L50
```
...
```{r, data-CV_LFC, results = FALSE, echo = TRUE}
data@CV_LFC
```
...
```{r, data-CV_LFS, results = FALSE, echo = TRUE}
data@CV_LFS
```
...
```{r, data-CV_wla, results = FALSE, echo = TRUE}
data@CV_wla
```
...
```{r, data-CV_wlb, results = FALSE, echo = TRUE}
data@CV_wlb
```
...
```{r, data-CV_steep, results = FALSE, echo = TRUE}
data@CV_steep
```
...
```{r, data-sigmaL, results = FALSE, echo = TRUE}
data@sigmaL
```
...
```{r, data-MaxAge, results = FALSE, echo = TRUE}
data@MaxAge
```
...
```{r, data-CAL_bins, results = FALSE, echo = TRUE}
data@CAL_bins
```
...
```{r, data-CAL, results = FALSE, echo = TRUE}
data@CAL
```
...
```{r, data-TAC, results = FALSE, echo = TRUE}
data@TAC
```
...
```{r, data-Sense, results = FALSE, echo = TRUE}
data@Sense
```
...
```{r, data-Units, results = FALSE, echo = TRUE}
data@Units
```
...
```{r, data-Ref, results = FALSE, echo = TRUE}
data@Ref
```
...
```{r, data-Ref_type, results = FALSE, echo = TRUE}
data@Ref_type
```
...
```{r, data-Log, results = FALSE, echo = TRUE}
data@Log
```
...
```{r, data-params, results = FALSE, echo = TRUE}
data@params
```
...
```{r, data-PosMPs, results = FALSE, echo = TRUE}
data@PosMPs
```
...
```{r, data-MPs, results = FALSE, echo = TRUE}
data@MPs
```
...
```{r, data-OM, results = FALSE, echo = TRUE}
data@OM
```
...
```{r, data-Obs, results = FALSE, echo = TRUE}
data@Obs
```
...
```{r, data-Cref, results = FALSE, echo = TRUE}
data@Cref
```
...
```{r, data-Iref, results = FALSE, echo = TRUE}
data@Iref
```
...
```{r, data-Bref, results = FALSE, echo = TRUE}
data@Bref
```
...
```{r, data-CV_Cref, results = FALSE, echo = TRUE}
data@CV_Cref
```
...
```{r, data-CV_Iref, results = FALSE, echo = TRUE}
data@CV_Iref
```
...
```{r, data-CV_Bref, results = FALSE, echo = TRUE}
data@CV_Bref
```
...
```{r, data-CV_Rec, results = FALSE, echo = TRUE}
data@CV_Rec
```
...
```{r, data-MPrec, results = FALSE, echo = TRUE}
data@MPrec
```
...
```{r, data-MPeff, results = FALSE, echo = TRUE}
data@MPeff
```
...
```{r, data-LHYear, results = FALSE, echo = TRUE}
data@LHYear
```
...
```{r, data-nareas, results = FALSE, echo = TRUE}
data@nareas
```
...
```{r, data-Misc, results = FALSE, echo = TRUE}
data@Misc
```
...
```{r, stock-Mgrad, results = FALSE, echo = TRUE}
stock@Mgrad
```
...
```{r, stock-Kgrad, results = FALSE, echo = TRUE}
stock@Kgrad
```
...
```{r, stock-Linfgrad, results = FALSE, echo = TRUE}
stock@Linfgrad
```
...
```{r, om-Mgrad, results = FALSE, echo = TRUE}
om@Mgrad
```
...
```{r, om-Kgrad, results = FALSE, echo = TRUE}
om@Kgrad
```
...
```{r, om-Linfgrad, results = FALSE, echo = TRUE}
om@Linfgrad
```
