...
```{r fit-vb, echo = knitr_echo, out.width="4in", fig.width=6}
mvb <- suppressWarnings(gfplot::fit_vb(d$survey_samples, sex = "all"))
...
mat_perc <- pbs2dlm:::extract_maturity_perc(stats::coef(m_mat$model))
...
mlw <- suppressWarnings(gfplot::fit_length_weight(d$survey_samples, sex = "all"))
