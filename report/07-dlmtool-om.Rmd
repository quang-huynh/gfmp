...
"Stock",    "Perr",       "$\\sigma_R$",                   "Magnitude of lognormal recruitment deviations ($\\sigma_R$ is \\texttt{Perr} transformed from a CV to an SD).",
...
"Stock",    "a",          "$\\alpha_W$",                   "Length-weight parameter alpha.",
"Stock",    "b",          "$\\beta_W$",                    "Length-weight parameter beta.",
...
"Obs",      "Cobs",       "$\\sigma_{C}$",                 "Lognormal catch observation error ($\\sigma_C$ is \\texttt{Cobs} transformed from a CV to an SD).",
#"Obs",      "Cbiascv",    "$b_C$",                         "Lognormal CV controlling the sampling of bias in catch observations for each simulation.",
"Obs",      "Iobs",       "$\\sigma_I$",                   "Observation error in the relative abundance indices ($\\sigma_I$ is \\texttt{Iobs} transformed from a CV to an SD).",
...
"Imp",      "TACSD",      "$\\sigma_\\textrm{bTAC}$",      "SD in lognormal fraction of TAC taken error."
)
