...
$$
\varepsilon_{I,y}\sim \textr{normal}\left( 0,{{\sigma}}_{I} \right)
(\#eq:dlm-om-epsiloni)
$$
...
$$
I_{\textrm{TAC},y} = {{b}}_{\textrm{TAC}}\textrm{\ exp}\left( \varepsilon_{\textrm{TAC},y} - \frac{{{\sigma}}_{\textrm{TAC}}}{2} \right)
(\#eq:dlm-om-itac)
$$
...
$$
b_{\textrm{TAC}} = \exp\left( \varepsilon_{\textrm{bTAC}} - \frac{\sigma_{\textrm{bTAC}}}{2} \right)
(\#eq:dlm-om-btac)
$$
...
After numerically solving Equation \@ref(eq:dlm-om-yeq) for $F_\textrm{MSY}$, $B_\textrm{MSY}$ is simply calculated:
