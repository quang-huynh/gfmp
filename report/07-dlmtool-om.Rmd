...
*TODO: fix this equation. It is rendering in html but not pdf*
<!--
\begin{equation}
...
where age-specific retention $r_a$, is modelled using the same form of double-normal curve as selectivity:
...
## OBSERVATION AND IMPLEMENTATION DYNAMICS

*TODO. RF will pull the necessary equations from @carruthers2018. Some will just be referred to the default slots (e.g., all implementation error settings)*
