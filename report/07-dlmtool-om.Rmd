...
term $\omega_{I,y}$ that includes bias and imprecision in the index observations:
...
When the index is recalculated, it is normalised to have a mean value of 1 over all years.
...
distribution whose standard deviation $\sigma_I$ is sampled at random in each simulation:
