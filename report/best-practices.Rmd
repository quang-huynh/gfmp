...
### 3. Selection of uncertainties/specification of OM(s)
...
### 4. Identification of candidate MPs
...
The role of science in this step is to ensure that results are clearly presented to decision-makers. Ideally this should include presentation of graphic outputs that enable clear comparison of MPs with respect to performance metrics and trade-offs [@punt2015]. For example, DLMtool contains numerous graphing and tabulation functions for summarizing outputs. The software also outputs a large range of result objects to enable analysts to create their own graphic and tabulated summaries.

A satisficing step may be used to screen out MPs that did not meet a minimum standard. After this, MP selection may be an iterative process, where MPs and/or OMs are refined following examination of results [e.g., @cox2008a]. In cases where there is a reference and robustness set of OMs, it may be necessary to weight OMs on the basis of plausibility, although this may be more of a qualitative approach and may not be straightforward [@punt2016].
