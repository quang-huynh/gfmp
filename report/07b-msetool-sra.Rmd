...
To estimate $F^{\textrm{eq}}_f$, the corresponding equilibrium catch in weight $C^{\textrm{eq}}_f$ prior to the first year of the model should be provided. In the equilibrium yield curve,  $F^{\textrm{eq}}_f$ would be the fishing mortality corresponding to fishing at $F^{\textrm{eq}}_f$.
