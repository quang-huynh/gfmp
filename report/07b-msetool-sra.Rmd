...
The user can specify a range of values for $h$ (e.g., 0.6 to 0.9 with a uniform distribution):
...
The SRA model reconstruction from the i-th fit will be conditioned on the i-th sampled value of $h$.
The sampled values of $h$ (as well as all other input parameters to the SRA) are then saved alongside the estimated parameters in the conditioned OM.
