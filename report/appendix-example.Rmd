...
This appendix outlines the setup and implementation of the  Shortraker rockfish (*Sebastes borealis*) operating model. It is not intended for use in a fisheries management context as presented here.
...
Let's start building the *Stock* object with the generic rockfish model and modify from there.
...
R~0~, the magnitude of unfished recruitment is fixed to an arbitrary value since it scales the simulated numbers:
...
Fraction of discarded fish that die. For `r species_name`, and most rockfish, this value should be at or near 100%.
...
Mean temporal trend in log-normal recruitment deviations. Need to look into exactly what this corresponds to. Trend over what period of time? TODO - this slot doesn't exist in the stock object
