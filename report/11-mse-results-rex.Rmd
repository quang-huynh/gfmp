...
(ref:fig-rex-proj) Historical and projected SSB/SSB~MSY~, F/F~MSY~, and catch across satisficed and reference MPs for the base OM.
...
```{r rex-proj, fig.cap="(ref:fig-rex-proj)", out.width="6.5in"}
...
Caption is otherwise the same as Figure \@ref(fig:rex-proj).
...
<!-- rex-spider-satisficed-panel.png -->
<!-- rex-sensitivity-yield-base.png -->
<!-- rex-sensitivity-traj-bbmsy-base.png-->
