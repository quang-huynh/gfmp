...
We down weighted the commercial CPUE by inflating the standard errors 1.5 times since we have greater confidence in the stratified random survey reflecting underlying biomass trends.
...
The majority of replicates were retained (Table \@ref(tab:rex-sra-fraction)), but by discarding the replicate initial OM parameter values associated with these non-converged models, the input parameters carried through to the conditioned OMs varied slightly (Figure \@ref(fig:rex-sra-conditioned-parameters2)).
