...
Dot on line plot of performance metrics across scenarios.
...
Colours represent the individual reference-set scenarios.
Lines represent medians and shaded regions represent 50% quantiles.
Satisficed in reference MPs are shown from top to bottom.
The scenarios are shown individually with example iterations in the following figures.
