...
TODO: add the other selectivity:
...
```{r rex-survey-fits, fig.cap="Survey fits.", out.width="0.7\\textwidth"}
...
Some OMs ("M increasing") have identical historical trajectories as "Catch eq. 50%", but with a fixed value of M in the historical period (i.e., the change in M only occurs in the projection period).
