...
* The "M increasing" OM scenario assumes that *M* was fixed at 0.2 in the historical period and increases monotonically from 0.2 to 0.4 *y*^-1^ over the projection period. This could represent increasing natural mortality due to a process such as climate change or shifts in predator abundance. We include this OM scenario simply to illustrate including a time-varying parameter in the OM projection period that reflects an underlying environmental process, and to assess robustness of MPs to such a scenario. We do not necessarily expect this to become a default robustness OM in applications of the framework.
...
Vertical dashed lines shows B/B~MSY~ of 0.4 (left) and 0.8 (right).
Horizontal dashed line shows F/F~MSY~ of 1.
