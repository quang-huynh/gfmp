...
We sampled 8000 iterations across four chains from the posterior and checked that the chains were consistent with convergence via the Rhat (potential scale reduction factor) and ESS (effective sample size) metrics along with traceplots of the samples [@gelman2014].
