...
```{r desc-stock-a-rex1, message=FALSE, warning=FALSE, echo=FALSE, results='hide'}
...
```{r desc-stock-a-rex, results = knitr_results, echo = knitr_echo, message=FALSE, warning=FALSE, fig.cap="(ref:desc-stock-a-rex)", fig.width=6, out.width="4in", message=FALSE}
