...
=======
A toolkit for applying closed-loop simulation for data-limited MPs has recently been developed by researchers at the University of British Columbia, in partnership with the Natural Resources Defense Council, DFO and other partners [@carruthers2018]. The Data-Limited Toolkit, [DLMtool](https://www.datalimitedtoolkit.org/), enables rapid assessment of a large number of data-limited MPs and ranking of MPs according to identified conservation and economic objectives.
>>>>>>> Additions to background for rex and shortraker
...
<<<<<<< HEAD
The project will present a methodology for developing appropriate OMs, testing suites of MPs, and identifying MPs that best meet the objectives of fisheries management and stakeholders for some example stocks with contrasting life histories. This work builds on recent work by @anderson2019synopsis, which is a comprehensive, reproducible data synopsis for all Pacific groundfish species encountered by DFO surveys and commercial fisheries in BC. Data and empirical analyses from the synopsis are used to develop OMs using the DLMtool toolkit [@carruthers2018], which are then used in simulation-testing a range of data-limited MPs against performance metrics. Steps of the process are described more fully in the next sections. 
=======
The project will focus on developing appropriate operating models, testing suites of management procedures, and determining management procedures that best meet the objectives of fisheries management and stakeholders for some example stocks with different life histories. This work builds on recent work by @anderson2019synopsis, which is a comprehensive, reproducible data synopsis for all <!--can we really say "all" here? Earlier it was mentioned that our surveys encounter 200 species--> Pacific groundfish species encountered by DFO surveys and commercial fisheries in BC. Data and empirical analyses from the synopsis are used to develop operating models within DLMtool [@carruthers2018], which are then used for simulation testing a range of data-limited MPs against performance metrics. The closed-loop simulation approach will allow analysts to use the available data for specific stocks rather than prescribing one MP per data tier, as in traditional "tiered" approaches. 
>>>>>>> Additions to background for rex and shortraker
