...
We emphasize that while the framework does not explicitly report biological reference points and stock status, which often cannot be reliably estimated for data-limited stocks, the framework is designed to evaluate MPs with respect to the probability of maintaining stocks above reference points over a range of uncertainties.
