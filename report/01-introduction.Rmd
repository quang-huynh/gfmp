...
This document aims to develop a management procedure framework (MP Framework) for selecting methods for provision of catch advice for Pacific groundfish stocks that do not have sufficient data for full statistical stock assessments. In doing so, it aims to improve the capacity of DFO to meet the Fish Stocks provisions of the *Fisheries Act* for data-limited species. The management procedure framework will apply closed-loop simulation to formalize the process of testing and selecting MPs for data-limited groundfish stocks, which will support the provision of scientific advice to fisheries managers. We choose the terminology MP Framework to clearly specify the focus on selection of best-performing MPs, rather than focusing on the available data.

This document presents a methodology for developing appropriate OMs, testing suites of MPs, and identifying MPs that best meet the objectives of fisheries management and stakeholders. This work builds on recent work by @anderson2019synopsis, which is a comprehensive, reproducible data synopsis for nearly all Pacific groundfish species encountered by DFO surveys and commercial fisheries in BC. In the proposed framework, data and empirical analyses from the synopsis are used to develop OMs using the DLMtool package [@carruthers2018] for the statistical software R [r2019], which are then used in simulation-testing a range of data-limited MPs against performance metrics. An R package written by the authors for this framework, gfdlm [TODO REF], houses many tools and custom visualizations to aid in the process. Steps of the process are described more fully in the following sections of the document.
