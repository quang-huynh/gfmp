...
(ref:fig-pa) Illustration of DFO's PA Framework. Based on @dfo2009.
...
The objective of the framework proposed in this document is to preserve the *intent* of the PA Framework, legislated in the Fish Stocks provisions, and provide decision-makers with a quantified characterization of risk with respect to the likelihood of maintaining stocks above the LRP, regardless of the quality of available data.
...
In doing so, it aims to improve the capacity of DFO to meet the requirements of Canada's SFF and the Fish Stocks provisions of the *Fisheries Act* for data-limited species.
...
In the proposed framework, data and empirical analyses from the synopsis are used to develop OMs using the DLMtool package [@carruthers2018] for the statistical software R [r2019], which are then used in simulation-testing a range of data-limited MPs against performance metrics. 
An R package written by the authors for this framework, gfdlm [https://github.com/pbs-assess/gfdlm], houses many tools and custom visualizations to aid in the process. 
