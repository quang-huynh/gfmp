...
Although the proposed framework is software agnostic, in the current implementation, data and empirical analyses from the synopsis are used to develop OMs using the DLMtool [@carruthers2018] and MSEtool packages [@huynh_msetool_2019], implemented in the statistical software R [@r2019]. The OMs are then used in simulation-testing a range of data-limited MPs against performance metrics.
