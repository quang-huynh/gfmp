...
Since 2017, a partnership agreement between the University of British Columbia (UBC) and DFO [@dfo_dlmtool_2017] has supported development of two open-source software packages for MSE, implemented in R [@rcoreteam2019]: the Data Limited Methods toolkit (DLMtool) [@carruthers2018; @carruthers_hordyk_2018] and the Management Strategy Evaluation toolkit (MSEtool) [@huynh_msetool_2019]. After several years of development, these packages provide some of the fastest, most flexible and extensible software for conducting MSE for fisheries, ranging from very data-poor to data-rich, enabling rapid assessment of multiple MPs, data-poor and/or data-rich, and ranking of MPs according to customizable conservation and economic objectives, and evaluation of key trade-offs.
