...
*The size of area 1 relative to total area. OMx has two default areas. Set to 0.5 to approximate single area model*
<!-- autogen-end -->
...
*The fraction of the unfished biomass in area 1. Uniform distribution lower and upper bounds. Positive real numbers*
<!-- autogen-end -->
...
Let's assume Pacific cod is vulnerable in almost all of its range - set a high probability of being in area 1, assuming area 1 is a refuge.

```{r desc-stock-prob_staying-pc, results = knitr_results, echo = knitr_echo}
stockpc@Prob_staying <- c(0.9, 0.99)
```
