...
# PACIFIC COD: OPERATING MODEL SPECIFICATION  {#app:desc-om-pacific-cod}
...
## STOCK SLOT DESCRIPTIONS {#app:desc-stock-pacific-cod}
...
<!-- slot-chunk-begin -->
### Name {#app:desc-stock-name-pacific-cod}

*The name of the Stock object. Single value. Character string*

```{r desc-stock-name-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Name <- "Pacific Cod 5ABCD Stock"
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Common_Name {#app:desc-stock-common_name-pacific-cod}

*Common name of the species. Character string*

```{r desc-stock-common_name-pacific-cod, results = knitr_results, echo = knitr_echo}
(stockpc@Common_Name <- species_name)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Species {#app:desc-stock-species-pacific-cod}

*Scientific name of the species. Genus and species name. Character string*

```{r desc-stock-species-pacific-cod, results = knitr_results, echo = knitr_echo}
(stockpc@Species <- science_name)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### maxage {#app:desc-stock-maxage-pacific-cod}

*The maximum age of individuals that is simulated (there is no plus group ). Single value. Positive integer*

```{r desc-stock-maxage-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@maxage <- max(dpc$survey_samples$age, na.rm = TRUE)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### R0 {#app:desc-stock-r0-pacific-cod}
...
```{r desc-stock-r0-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@R0 <- c(2331,3902)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### M {#app:desc-stock-m-pacific-cod}

*Natural mortality rate. Uniform distribution lower and upper bounds. Positive real number*

Lower and upper values of the 95% credibility interval of posterior distribution [@forrest2019].

```{r desc-stock-m-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@M <- c(0.28, 0.347)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### M2 {#app:desc-stock-m2-pacific-cod}

*(Optional) Natural mortality rate at age. Vector of length maxage . Positive real number*

Not used.

```{r desc-stock-m2-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@M2
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Mexp {#app:desc-stock-mexp-pacific-cod}
...
```{r desc-stock-mexp-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Mexp <- c(NA_real_, NA_real_)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Msd {#app:desc-stock-msd-pacific-cod}
...
```{r desc-stock-msd-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Msd <- c(0.00, 0.1)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### h {#app:desc-stock-h-pacific-cod}

*Steepness of the stock recruit relationship. Uniform distribution lower and upper bounds. Values from 1/5 to 1*

Lower and upper values of the 95% credibility interval of posterior distribution [@forrest2019].

```{r desc-stock-h-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@h <- c(0.432, 0.931)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### SRrel {#app:desc-stock-srrel-pacific-cod}
...
```{r desc-stock-srrel-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@SRrel <- 1L
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Perr {#app:desc-stock-perr-pacific-cod}
...
```{r desc-stock-perr-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Perr <- c(0.6, 1.0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### AC {#app:desc-stock-ac-pacific-cod}
...
```{r desc-stock-ac-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@AC <- c(0.0, 0.7)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Period {#app:desc-stock-period-pacific-cod}
...
```{r desc-stock-period-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Period
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Amplitude {#app:desc-stock-amplitude-pacific-cod}
...
```{r desc-stock-amplitude-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Amplitude
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Linf {#app:desc-stock-linf-pacific-cod}
...
```{r desc-stock-linf-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Linf <- c(88.7,103.4)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### K {#app:desc-stock-k-pacific-cod}
...
```{r desc-stock-k-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@K <-c(0.17,0.22)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### t0 {#app:desc-stock-t0-pacific-cod}

*von Bertalanffy theoretical age at length zero. Uniform distribution lower and upper bounds. Non-positive real numbers*

Lower and upper values of the confidence interval for Hecate Strait and Queen Charlotte Sound combined [@forrest2019, their Appendix C].

```{r desc-stock-t0-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@t0 <- c(-0.91, -0.72)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LenCV {#app:desc-stock-lencv-pacific-cod}
...
```{r desc-stock-lencv-pacific-cod, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-begin -->
### Ksd {#app:desc-stock-ksd-pacific-cod}
...
```{r desc-stock-ksd-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Ksd <- c(0, 0.2)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Linfsd {#app:desc-stock-linfsd-pacific-cod}
...
```{r desc-stock-linfsd-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Linfsd <- c(0, 0.2)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### L50 {#app:desc-stock-l50-pacific-cod}
...
```{r desc-stock-l50-pacific-cod, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-begin -->
### L50_95 {#app:desc-stock-l50_95-pacific-cod}
...
```{r desc-stock-l50_95-pacific-cod, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-begin -->
### D {#app:desc-stock-d-pacific-cod}
...
```{r desc-stock-d-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@D <- c(0.45, 0.92)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### a {#app:desc-stock-a-pacific-cod}
...
```{r desc-stock-a-pacific-cod, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-begin -->
### Size_area_1 {#app:desc-stock-size_area_1-pacific-cod}
...
```{r desc-stock-size_area_1-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Size_area_1 <- c(0.49,0.51)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Frac_area_1 {#app:desc-stock-frac_area_1-pacific-cod}
...
```{r desc-stock-frac_area_1-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Frac_area_1 <- c(0.49,0.51)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Prob_staying {#app:desc-stock-prob_staying-pacific-cod}
...
```{r desc-stock-prob_staying-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Prob_staying <- c(0.49,0.51)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Fdisc {#app:desc-stock-fdisc-pacific-cod}
...
```{r desc-stock-fdisc-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Fdisc <- 0.99
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Source {#app:desc-stock-source-pacific-cod}
...
```{r desc-stock-source-pacific-cod, results = knitr_results, echo = knitr_echo}
stockpc@Source <- ""
```
<!-- slot-chunk-end -->

## FLEET SLOT DESCRIPTIONS {#app:desc-fleet-pacific-cod}
...
<!-- slot-chunk-begin -->
### Name {#app:desc-fleet-name-pacific-cod}

*Name of the Fleet object. Single value. Character string.*

```{r desc-fleet-name-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@Name <- "BC Trawl Fleet"
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### nyears {#app:desc-fleet-nyears-pacific-cod}
...
```{r desc-fleet-nyears-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@nyears <- 62
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Spat_targ {#app:desc-fleet-spat_targ-pacific-cod}
...
```{r desc-fleet-spat_targ-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@Spat_targ
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### EffYears {#app:desc-fleet-effyears-pacific-cod}

*Years representing join-points (vertices) of time-varying effort. Vector. Non-negative real numbers*

For now, derive these as approximations of the effort timeseries from the CPUE standardization analyses. Use the time series from our "fleet" that is most relevant to catching Pacific Cod.

```{r desc-fleet-effyears-pacific-cod, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-begin -->
### EffLower {#app:desc-fleet-efflower-pacific-cod}
...
```{r desc-fleet-efflower-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@EffLower <- fleet_effort$effort_lower
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### EffUpper {#app:desc-fleet-effupper-pacific-cod}

*Upper bound on relative effort corresponding to EffYears. Vector. Non-negative real numbers*

TODO: May need to come up with some plausible scenarios for these effort trajectories.

```{r desc-fleet-effupper-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@EffUpper <- fleet_effort$effort_upper
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Esd {#app:desc-fleet-esd-pacific-cod}
...
```{r desc-fleet-esd-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@Esd <- c(0.1, 0.4)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### qinc {#app:desc-fleet-qinc-pacific-cod}
...
```{r desc-fleet-qinc-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@qinc <- c(0, 0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### qcv {#app:desc-fleet-qcv-pacific-cod}
...
```{r desc-fleet-qcv-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@qcv <- c(0.1, 0.2)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### L5 {#app:desc-fleet-l5-pacific-cod}
...
```{r desc-fleet-l5-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@L5 <- c(0.2, 0.4)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFS {#app:desc-fleet-lfs-pacific-cod}
...
```{r desc-fleet-lfs-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@LFS <- c(0.95, 1.1)#c(1.0, 1.2) #
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Vmaxlen {#app:desc-fleet-vmaxlen-pacific-cod}
...
```{r desc-fleet-vmaxlen-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@Vmaxlen <-  c(1, 1) #c(0.05, 0.95) #
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### isRel {#app:desc-fleet-isrel-pacific-cod}

*Selectivity parameters in units of size-of-maturity (or absolute eg cm). Single value. Boolean.*

```{r desc-fleet-isrel-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@isRel
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LR5 {#app:desc-fleet-lr5-pacific-cod}
...
```{r desc-fleet-lr5-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@LR5 #<- c(0.2, 0.4)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFR {#app:desc-fleet-lfr-pacific-cod}
...
```{r desc-fleet-lfr-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@LFR #<- c(0.95, 0.99)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Rmaxlen {#app:desc-fleet-rmaxlen-pacific-cod}
...
```{r desc-fleet-rmaxlen-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@Rmaxlen #<- c(0.99, 1.5)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### DR {#app:desc-fleet-dr-pacific-cod}

*Discard rate - the fraction of caught fish that are discarded. Uniform distribution lower and upper bounds. Fraction*

```{r desc-fleet-dr-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@DR #<- c(0.01,0.05)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### SelYears {#app:desc-fleet-selyears-pacific-cod}
...
```{r desc-fleet-selyears-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@SelYears
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### AbsSelYears {#app:desc-fleet-absselyears-pacific-cod}
...
```{r desc-fleet-absselyears-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@AbsSelYears
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### L5Lower {#app:desc-fleet-l5lower-pacific-cod}

*(Optional) Lower bound of L5 (use ChooseSelect function to set these). Vector. Non-negative real numbers*

```{r desc-fleet-l5lower-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@L5Lower
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### L5Upper {#app:desc-fleet-l5upper-pacific-cod}

*(Optional) Upper bound of L5 (use ChooseSelect function to set these). Vector. Non-negative real numbers*

```{r desc-fleet-l5upper-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@L5Upper
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFSLower {#app:desc-fleet-lfslower-pacific-cod}

*(Optional) Lower bound of LFS (use ChooseSelect function to set these). Vector. Non-negative real numbers*

```{r desc-fleet-lfslower-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@LFSLower
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFSUpper {#app:desc-fleet-lfsupper-pacific-cod}

*(Optional) Upper bound of LFS (use ChooseSelect function to set these). Vector. Non-negative real numbers*

```{r desc-fleet-lfsupper-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@LFSUpper
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### VmaxLower {#app:desc-fleet-vmaxlower-pacific-cod}

*(Optional) Lower bound of Vmaxlen (use ChooseSelect function to set these). Vector. Fraction*

```{r desc-fleet-vmaxlower-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@VmaxLower
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### VmaxUpper {#app:desc-fleet-vmaxupper-pacific-cod}

*(Optional) Upper bound of Vmaxlen (use ChooseSelect function to set these). Vector. Fraction*

```{r desc-fleet-vmaxupper-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@VmaxUpper
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### CurrentYr {#app:desc-fleet-currentyr-pacific-cod}

*The current calendar year (final year) of the historical simulations (eg 2011). Single value. Positive integer.*

```{r desc-fleet-currentyr-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@CurrentYr <- 2018
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### MPA {#app:desc-fleet-mpa-pacific-cod}

*(Optional) Matrix specifying spatial closures for historical years.*

We will not use this functionality.

```{r desc-fleet-mpa-pacific-cod, results = knitr_results, echo = knitr_echo}
fleetpc@MPA
```
<!-- slot-chunk-end -->

## OBS SLOT DESCRIPTIONS {#app:desc-obs-pacific-cod}
...
<!-- slot-chunk-begin -->
### Name {#app:desc-obs-name-pacific-cod}

*The name of the observation model object. Single value. Character string.*

```{r desc-obs-name-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Name <- "BC Obs"
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Cobs {#app:desc-obs-cobs-pacific-cod}
...
```{r desc-obs-cobs-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Cobs <- c(0.05, 0.15)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Cbiascv {#app:desc-obs-cbiascv-pacific-cod}
...
```{r desc-obs-cbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Cbiascv <- 0.05
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### CAA_nsamp {#app:desc-obs-caa_nsamp-pacific-cod}
...
```{r desc-obs-caa_nsamp-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@CAA_nsamp
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### CAA_ESS {#app:desc-obs-caa_ess-pacific-cod}
...
```{r desc-obs-caa_ess-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@CAA_ESS
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### CAL_nsamp {#app:desc-obs-cal_nsamp-pacific-cod}

*Number of catch-at-length observation per time step. Uniform distribution lower and upper bounds. Positive integers*

```{r desc-obs-cal_nsamp-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@CAL_nsamp
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### CAL_ESS {#app:desc-obs-cal_ess-pacific-cod}
...
```{r desc-obs-cal_ess-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@CAL_ESS
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Iobs {#app:desc-obs-iobs-pacific-cod}
...
```{r desc-obs-iobs-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Iobs <- c(0.3, 0.5)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Ibiascv {#app:desc-obs-ibiascv-pacific-cod}
...
```{r desc-obs-ibiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Ibiascv <- c(0.333, 3.00)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Btobs {#app:desc-obs-btobs-pacific-cod}
...
```{r desc-obs-btobs-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Btobs <- obspc@Iobs
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Btbiascv {#app:desc-obs-btbiascv-pacific-cod}
...
```{r desc-obs-btbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Btbiascv <- obspc@Ibiascv
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### beta {#app:desc-obs-beta-pacific-cod}
...
```{r desc-obs-beta-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@beta <- c(0.666, 1.500)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LenMbiascv {#app:desc-obs-lenmbiascv-pacific-cod}
...
```{r desc-obs-lenmbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@LenMbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Mbiascv {#app:desc-obs-mbiascv-pacific-cod}
...
```{r desc-obs-mbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Mbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Kbiascv {#app:desc-obs-kbiascv-pacific-cod}
...
```{r desc-obs-kbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Kbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### t0biascv {#app:desc-obs-t0biascv-pacific-cod}
...
```{r desc-obs-t0biascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@t0biascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Linfbiascv {#app:desc-obs-linfbiascv-pacific-cod}
...
```{r desc-obs-linfbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Linfbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFCbiascv {#app:desc-obs-lfcbiascv-pacific-cod}
...
```{r desc-obs-lfcbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@LFCbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### LFSbiascv {#app:desc-obs-lfsbiascv-pacific-cod}
...
```{r desc-obs-lfsbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@LFSbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### FMSYbiascv {#app:desc-obs-fmsybiascv-pacific-cod}
...
```{r desc-obs-fmsybiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@FMSYbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### FMSY_Mbiascv {#app:desc-obs-fmsy_mbiascv-pacific-cod}
...
```{r desc-obs-fmsy_mbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@FMSY_Mbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### BMSY_B0biascv {#app:desc-obs-bmsy_b0biascv-pacific-cod}
...
```{r desc-obs-bmsy_b0biascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@BMSY_B0biascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Irefbiascv {#app:desc-obs-irefbiascv-pacific-cod}
...
```{r desc-obs-irefbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Irefbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Brefbiascv {#app:desc-obs-brefbiascv-pacific-cod}
...
```{r desc-obs-brefbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Brefbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Crefbiascv {#app:desc-obs-crefbiascv-pacific-cod}
...
```{r desc-obs-crefbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Crefbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Dbiascv {#app:desc-obs-dbiascv-pacific-cod}
...
```{r desc-obs-dbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Dbiascv <- c(0.1, 0.3)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Dobs {#app:desc-obs-dobs-pacific-cod}
...
```{r desc-obs-dobs-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Dobs
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### hbiascv {#app:desc-obs-hbiascv-pacific-cod}
...
```{r desc-obs-hbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@hbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### Recbiascv {#app:desc-obs-recbiascv-pacific-cod}
...
```{r desc-obs-recbiascv-pacific-cod, results = knitr_results, echo = knitr_echo}
obspc@Recbiascv <- c(0.05, 0.20)
```
<!-- slot-chunk-end -->

## IMP SLOT DESCRIPTIONS {#app:desc-imp-pacific-cod}
...
<!-- slot-chunk-begin -->
### Name {#app:desc-imp-name-pacific-cod}

*The name of the Implementation error object. Single value. Character string.*

```{r desc-imp-name-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@Name <- "BC Implementation"
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### TACFrac {#app:desc-imp-tacfrac-pacific-cod}

*Mean fraction of TAC taken. Uniform distribution lower and upper bounds. Positive real number.*

```{r desc-imp-tacfrac-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@TACFrac <- c(0.8, 1.0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### TACSD {#app:desc-imp-tacsd-pacific-cod}
...
```{r desc-imp-tacsd-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@TACSD <- c(0, 0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### TAEFrac {#app:desc-imp-taefrac-pacific-cod}

*Mean fraction of TAE taken. Uniform distribution lower and upper bounds. Positive real number.*

```{r desc-imp-taefrac-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@TAEFrac <- c(0.8, 1.0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### TAESD {#app:desc-imp-taesd-pacific-cod}
...
```{r desc-imp-taesd-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@TAESD <- c(0, 0)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### SizeLimFrac {#app:desc-imp-sizelimfrac-pacific-cod}
...
```{r desc-imp-sizelimfrac-pacific-cod, results = knitr_results, echo = knitr_echo}
imppc@SizeLimFrac <- c(1, 1)
```
<!-- slot-chunk-end -->

<!-- slot-chunk-begin -->
### SizeLimSD {#app:desc-imp-sizelimsd-pacific-cod}
...
```{r desc-imp-sizelimsd-pacific-cod, results = knitr_results, echo = knitr_echo}
