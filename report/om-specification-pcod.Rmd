...
# PACIFIC COD: OPERATING MODEL SPECIFICATION {#app:desc-om}
...
stockpc@maxage <- max(d$survey_samples$age, d$commercial_samples$age, na.rm = TRUE)
```
...
stockpc@Prob_staying <- c(0.1, 0.9)
```
