...
* `plot_scenario_projections()` takes a named list of DLMtool simulations and creates a time-series plot of historical and projected *B*/*B*~MSY~, *F*/*F*~MSY~, and catch with all scenarios overlaid on the same plots using different colours. For example, Figure \@ref(fig:rex-proj-scenarios).
