...
TODO: A little introduction here.

All functions are set up to take either:
...
* `plot_kobe()` takes a named list of DLMtool simulations and creates a Kobe plot for the last projected year. For example, Figure \@ref(fig:rex-kobe).
...
* `plot_factory()` is the one plotting function to rule them all. This function takes a named list of DLMtool simulations along with a number of other arguments specifying characteristics like satisficed MPs and performance metrics and generates common versions of all the figures described below. The output is a named list of ggplot2 [REF] elements that can be viewed, modified, and/or saved for inclusion in a report. For example, this function was used to create all the main figures in the Rex Sole case study in this document.
