...
if (!file.exists(here::here("generated-data/rex-survey-sets.rds"))) {
  dsurv <- gfdata::get_survey_sets("rex sole", ssid = 1)
  saveRDS(dsurv, here::here("generated-data/rex-survey-sets.rds"))
} else {
  dsurv <- readRDS(here::here("generated-data/rex-survey-sets.rds"))
}
if (!file.exists(here::here("generated-data/rex-cpue-spatial.rds"))) {
  dcomm <- gfdata::get_cpue_spatial("rex sole")
  saveRDS(dcomm, here::here("generated-data/rex-cpue-spatial.rds"))
} else {
  dcomm <- readRDS(here::here("generated-data/rex-cpue-spatial.rds"))
}

# dsurv <- readRDS(here::here("../../gfs/report/data-cache/rex-sole.rds"))$survey_sets
# dcomm <- readRDS(here::here("../../gfs/report/data-cache/rex-sole.rds"))$cpue_spatial
