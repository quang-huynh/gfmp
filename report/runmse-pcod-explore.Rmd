...
probs <- get_probs(pcod_mse_short, PMlist = c("P40", "P80", "PNOF", "AAVY", "LTY"))
plot_probs(probs)
```
...
x <- eval_pm(pcod_mse_short,
             pm_list = list("LTY",
                            ...
                            "P100",
                            "PNOF",
                            "AAVY")) %>% select(mp, pm, prob)

#r_plot(x, fill_polys = TRUE, inc_yrs = FALSE)
ggspider::spider_web(as.data.frame(x), "mp", "pm", "prob")
