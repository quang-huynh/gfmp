...
We recommend that products such as [DFO's sustainability survey](https://www.dfo-mpo.gc.ca/reports-rapports/regs/sff-cpd/survey-sondage/index-en.html) be flexible to accommodate status reports from MSE processes, which may use alternative wording such as "under the current management procedure, the stock has a less than 5% probability of being below the LRP over a 50-year time frame".
...
<!-- TODO: Robyn: I took a first stab at this, but please edit as needed. Especially the DLMtool partnership part and J. Holmes. -->

We thank the technical work group members Rob Kronlund, Adam Keizer, Ashleen Benson, Tom Carruthers, Dana Haggarty, Rowan Haigh, Adrian Hordyk, Roger Kanno, Paul Starr, Rob Tadey, and Greg Workman for helpful discussions and comments on earlier drafts of this document.
We thank John Holmes for supporting our work on this framework within the Stock Assessment and Research division at Pacific Biological Station.
We especially thank Tom Carruthers and Adrian Hordyk their work developing DLMtool.
Without DLMtool this project would have been a much bigger undertaking and their helpful guidance and many new features added on request have greatly improved the Framework.
