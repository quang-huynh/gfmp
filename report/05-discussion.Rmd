...
We recommend that products such as [DFO's sustainability survey](https://www.dfo-mpo.gc.ca/reports-rapports/regs/sff-cpd/survey-sondage/index-en.html) be flexible to accomodate status reports from MSE processes, which may use wording such as "under the current management procedure, the stock has a less than 5% probability of being below the LRP over a 50-year time frame".
...
We do not recommend a specific interval between assessments in this framework but note that the MP Framework itself can be used to test appropriate re-assessment intervals for individual species [e.g., @huynh2020].
