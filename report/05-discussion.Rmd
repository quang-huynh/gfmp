...
A weight of evidence approach may include considerations of combined contributions of individual studies (totality of evidence), and expert judgement-assigned weights for each line of evidence, where a line of evidence may consist of one or more studies.
We suggest that if conditioned OMs place a high probability of a fish stock being in the critical zone across a range of plausible OM assumptions, this could contribute to the evidence used to trigger a rebuilding plan.
