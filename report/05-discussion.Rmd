...
However, we suggest that if conditioned OMs place a high probability of a fish stock being in the Critical Zone across a range of plausible OM assumptions, this could be grounds for triggering a rebuilding plan.
DFO Science is currently developing more detailed guidance on the criteria required to trigger a rebuilding plan [**REF**], in light of new legislative requirements under the  Fish Stocks provisions (Section \@ref(sec:intro-motivation)).
<!-- Have asked Rob K for the latest draft of the rebuilding guidance. May add more to this once received-->
