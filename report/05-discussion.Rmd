...
The MP Framework therefore increases capacity for provision of Sustainable-Fisheries-Framework- and Fish-Stocks-Provisions-compliant catch advice for data-limited species.
...
For example, applications of this framework could quantify the expected change in the probability of maintaining a stock above its LRP in the long run given reductions or expansions in random-stratified survey programs.

The MP Framework could also be used to evaluate whether improved MP performance could be achieved by ageing toliths for a given stock.
...
This project would have been a much bigger undertaking without these tools. Tom and Adrian's helpful guidance and willingness to add many new features on request have greatly improved this document.
