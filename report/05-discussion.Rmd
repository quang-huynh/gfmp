...
Typical data types that could be included in value-of-information analyses in applications of this framework for BC groundfish include survey-index and age-composition data.
In terms of survey-index data, the Framework could be used to test the sensitivity of MP performance to changes in the precision of population indexes.
For example, the Framework could quantify the expected change in the probability of maintaining a stock above its LRP in the long run given reductions or expansions in random-stratified survey programs.

The Framework could also be used to evaluate whether improved MP performance could be achieved by ageing toliths for a given stock.
