...
<!--Importantly, when an MSE approach is applied in provision of management advice, decision-makers, stakeholders, and other interested parties (e.g., First Nations, Nongovernmental Organizations [NGOs], and academics) should be engaged throughout the process, particularly in defining the decision context, setting objectives and performance metrics, and selection of MPs [e.g., @cox2008a].-->
...
* What are specific roles and responsibilities of parties involved. Parties may include science, management, First Nations, industry, academia, or non-governmental organizations (NGOs).
