...
For example, while resource users may place higher value on increased biological production, aboriginal users may prefer more stable access to yields and increased participation [@plaganyi2013] or have spatial objectives [@okamoto2020]. Recreational users may prefer lower yields and larger trophy fish [@hilborn2007].
