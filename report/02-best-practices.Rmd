...
Once the OM and MPs are fully specified, the MSE simulation replicates can be run, following the process illustrated in Figure \@ref(fig:mse-chart).
...
<!-- TODO: we aren't advocating this two-step approach later -->
