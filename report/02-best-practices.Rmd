...
We propose the following provisional performance metrics, MSY refers to maximum sustainable yield, *SB*~MSY~ refers to equilibrium spawning biomass at MSY, and *F*~MSY~ refers to the fishing mortality that produces MSY over the long term:
