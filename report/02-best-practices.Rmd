...
For example, the initial reference set may be based on the set of sensitivity analyses presented in the stock assessment [e.g., Atlantic Bluefin Tuna (*Thunnus thynnus*), **REF**].
