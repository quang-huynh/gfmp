...
Two basic approaches may be used in selecting the final MP: satisficing and trading-off evaluation, where satisficing involves setting minimum performance standards (described in Section \@ref(sec:best5)) and trading-off evaluation involves decision-makers and stakeholders finding a balance among competing performance metrics [@punt2017]. We already described an early satisficing step to screen out poorly performing MPs.
