...
* How will the process be governed? For example, how will aceptability of trade-offs be determined? How will meetings be facilitated? How will consultation be managed? Failures in governance of the decision-making process can lead to a less succesful decisions in terms of acceptance and compliance [@smith1999; @armitage2019].
...
For example, while all resource users may place higher value on increased biological production, aboriginal users may prefer more stable access to yields and increased participation [@plaganyi2013] or have spatial objectives [@okamoto2020]. Recreational users may prefer lower yields and larger trophy fish [@hilborn2007].
