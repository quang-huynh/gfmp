...
The TAC is the average historical catch over the last N years (default 5). Note CC2, CC3 CC4, CC5 represent the same MP but with the catch multiplied by 0.9, 0.8, 0.7, and 0.6 respectively.
