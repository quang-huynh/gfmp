...
**Fratio** - Calculates the overfishing limit based on a fixed ratio of FMSY to M multiplied by a current estimate of abundance. This method requires as estimate of current abundance. Special case management procedures *Fratio_CC* and *Fratio_ML* estimate current abundance using average catch and an estimate of F from an age-based catch curve and mean lengths respectively. See @gulland1971 and @martell2013\.


**GB_CC** - Geromont and Butterworth Constant Catch is a simple MP that aims for a reference catch (as a proxy for MSY) subject to imperfect information. The TAC is calculated to be equivalent to a reference catch which is assumed to be a proxy for MSY.
