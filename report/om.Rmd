...
<<<<<<< Updated upstream
Available output and reference management procedures:
=======
*AvC* - Average Catch
The mean historical catch is calculated and used to set a constant catch limit (TAC). If the number of stochastic samples of the MP recommendation(s) is greater than 1 then those samples are drawn from a log-normal distribution with mean TAC and standard deviation (in log-space) of 0.2.

*CC1* - Geromont and Butterworth (2015) Constant Catch
The TAC is the average historical catch over the last N years (default 5).

*CC2* - Geromont and Butterworth (2015) Constant Catch
The TAC is the average historical catch over the last N years (default 5), multiplied by 0.9.

*CC3* - Geromont and Butterworth (2015) Constant Catch
The TAC is the average historical catch over the last N years (default 5), multiplied by 0.8.

*CC4* - Geromont and Butterworth (2015) Constant Catch
The TAC is the average historical catch over the last N years (default 5), multiplied by 0.7.

*CC5* - Geromont and Butterworth (2015) Constant Catch
The TAC is the average historical catch over the last N years (default 5), multiplied by 0.6.
