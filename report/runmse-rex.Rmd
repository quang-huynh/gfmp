...
```{r, fig.cap="Historical trajectories from the operating model", fig.width=9.5, out.width="5in"}
...
```{r, fig.cap="Spider plots", out.width="4.5in", fig.width=10}
