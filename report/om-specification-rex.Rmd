...
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
### Cobsrex {#app:desc-obs-cobsrex-rex}
...
```{r desc-obs-cobsrex-rex, results = knitr_results, echo = knitr_echo}
obsrex@Cobs <- c(0, 0)
```
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
...
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
### Iobsrex {#app:desc-obs-iobsrex-rex}
...
```{r desc-obs-iobsrex-rex, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
### Btobsrex {#app:desc-obs-btobsrex-rex}
...
```{r desc-obs-btobsrex-rex, results = knitr_results, echo = knitr_echo}
...
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
### Dobsrex {#app:desc-obs-dobsrex-rex}
...
```{r desc-obs-dobsrex-rex, results = knitr_results, echo = knitr_echo}
obsrex@Dobs
```
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
