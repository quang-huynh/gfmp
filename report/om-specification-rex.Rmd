...
fleet_rex@qcv <- c(0, 0)
fleet_rex@EffYears <- all_years
fleet_rex@EffLower <- rep(1, length(all_years))
fleet_rex@EffUpper <- rep(1, length(all_years))
```
...
obs_rex <- DLMtool::Generic_Obs # TODO: temporary
```
