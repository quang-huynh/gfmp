...
Based on the observed commercial length samples this appears to be around or just slightly larger than the length at maturity. Let's make this slightly larger than `L5`, which effectively makes this almost knife-edged selectivity:
FIXME

```{r desc-fleetrex-lfs-rex, results = knitr_results, echo = knitr_echo}
fleetrex@LFS <- fleetrex@L5 * 1.1
```
<!-- slot-chunk-end -->
<!-- slot-chunk-begin -->
