...
We selected 50 years as a time-frame that should lead to relatively stable behaviour of MPs for shorter-lived stocks such as flatfishes (e.g., case study in Appendix \@ref(app:mse-rex)).
As an example for a longer-lived stock, the first application of this framework for decision-making is evaluation of rebuilding strategies for Inside Yelloweye Rockfish (*S. ruberrimus*) [@haggarty2020yelloweye], which evaluates long-term performance metrics over 1.5 generation times (56 years), but also evaluates additional probability of extinction metrics, required for COSEWIC evaluation, over a projection period of 100 years.
