...
3. FMSY: P(*F* < *F*~MSY~) (over entire projection)
...
$$\textrm{LT LRP}= \frac{\sum_{n = 1}^{n_{rep}}\sum_{t = t_1}^{t_2}B_t > 0.4B_\textrm{MSY}}{t_2 - t_1 + 1},$$
...
These authors evaluated long-term performance metrics over 1.5 generation times (in the 56th year), but also calculated probability of extinction metrics, required for COSEWIC evaluation, after 100 years.
...
We suggest reporting AADC relative to AADC in some historical period that stakeholders identify as having acceptable annual variation in catch.
