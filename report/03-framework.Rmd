...
where $t_1$ and $t_2$ are the first and last years over which the metric is calculated, and $n_{rep}$ is the number of replicate simulations. The other performance metrics are calculated in the same way.
...
For example, requiring that a threshold is met in each and every year as in [@ices2016criteria] is a stricter requirement than requiring a threshold to be met on average over replicates and years.
