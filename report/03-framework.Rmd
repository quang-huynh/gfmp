...
where $t_1$ and $t_2$ are the first and last years over which the metric is calculated, and $n_rep$ is the number of replicate simulations. The other performance metrics are calculated in the same way.
