...
Note that sensitivity of the timeseries to OM scenarios does not necessarily correspond to sensitivity in terms of rank order of performance metrics, which is ultimately the important result in an MP Framework.
