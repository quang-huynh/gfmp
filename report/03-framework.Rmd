...
1. LT LRP: Probability SB > 0.4 *B*~MSY~ (long-term year range)
2. LT USR: Probability SB > 0.8 *B*~MSY~ (long-term year range)
...
The "long-term year range" should be defined on a stock-by-stock basis. However, barring some other specified requirement for a definition of long-term (e.g., an associated COSEWIC assessment), we suggest the following starting points:

- Consider "long-term" as a year or short window before (e.g., 5--15 years) 2--3 generation times of the species.
- If that generation time window is less than 50 years, consider long-term as 50 years and some 5--15 year window before it.
...
Parameters under the four components are entered into "slots" [terminology referring to a feature of the S4 object-oriented system in R; @r2019], described in detail in Appendix \@ref(app:dlmtool-om) and in Appendix B of @carruthers2018.
...
The framework presented here has been designed to accommodate new MPs relatively easily and we expect the library of candidate MPs to grow over time, with the framework providing a means to rigorously test new MPs through the closed-loop simulation process.
