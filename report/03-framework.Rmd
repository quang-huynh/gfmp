...
We selected the alternative of 50 years as an arbitrary time-frame, which should lead to relatively stable behaviour of MPs for many shorter-lived stocks (e.g., flatfishes).
However, @dfo2009 and @dfo2013rebuilding recommend that longer time periods be used for longer-lived stocks such as rockfishes (*Sebastes* spp.).
For example, the first application of this framework for decision-making is evaluation of rebuilding strategies for Inside Yelloweye Rockfish (*S. ruberrimus*) [@haggarty2020yelloweye], which evaluates long-term performance metrics over 1.5 generation times (56 years), but also evaluates additional probability of extinction metrics over 100 years.
