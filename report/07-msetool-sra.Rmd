...
If the stock is assumed to be unfished in the first year of the historical period ($y= t_1$), unfished conditions are modeled by setting $F^{\textrm{eq}}_f = 0$. In practical terms, this is done by the user setting the equilibrium catch for each fleet to zero ($C^\textrm{eq}_f = 0$).
