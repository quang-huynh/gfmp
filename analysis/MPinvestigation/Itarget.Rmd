...
Something funny about itarget 5 as I have implemented it. I could have made a mistake but I think my code is the same as in gfdlm. In the GFMP working paper it looks like it has a cap on it that isn't documented ??? Just trying to understand so I can explain it (to myself and others who ask). So please tell me what I have missed or done incorrectly.

*To compare the base B&G2015 Itarget MPs and Itarget5, compare the green lines (whih have w=0.5) to the pink lines*. Two plots for each MP with different x axes.
